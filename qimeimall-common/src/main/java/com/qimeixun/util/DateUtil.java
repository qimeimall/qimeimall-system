...
public class DateUtil {
	 ...
	 * 日期格式，年月日时分秒，例如：20001230120000，20080808200808
	 */
	public static final String DATE_TIME_FORMAT_HHMISSSSS = "HHmmssSSS";
	...
	public static final String DATE_TIME_FORMAT_YYYYMMDD_EXACT = "yyyy/MM/dd HH:mm:ss";
	/**
	 * 日期格式，年月日时分秒毫秒
	 */
	...
	/**
	 * @desc 获取当前日期时间字符串（格式：yyyy-MM-dd HH:mm:ss）
	 * @author yueyufan
	 * @date 2020年1月2日 上午9:36:01
	 * @return String
	 */
	 ...
	 * @return
	 */
	public static Date getSubDayBeginTime(int i) {
		Calendar c = Calendar.getInstance();
		c.setTime(new Date());
	...
	/**
	 * 获取i天前 那天 23:59:59.999 的时间
	 *
	 * @param i
	 * @return
	 */
	public static Date getSubDayEndTime(int i) {
		Calendar c = Calendar.getInstance();
		c.setTime(new Date());
		c.set(Calendar.DAY_OF_MONTH, -i);
		c.set(Calendar.HOUR_OF_DAY, 23);
	 ...
	 * @return
	 */
	public static Date getDateAddYear(final Date date, final int yearNum) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);// 设置起时间
		cal.add(Calendar.YEAR, yearNum);// 增加yearNum年
		return cal.getTime();
	}
	 ...
	 * @return
	 */
	public static Date getDateAddDay(final Date date, final int dayNum) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);// 设置起时间
		cal.add(Calendar.DAY_OF_MONTH, dayNum);// 增加yearNum年
		return cal.getTime();
	}
	...
	public static String getStartTime(String date) {
		...
		// 将时间进行格式化
		String startTime = beginTime.format(dtf);

		// 设置当天的结束时间
		LocalDateTime endTime = LocalDateTime.of(nowDate, LocalTime.MAX);
		// 将时间进行格式化
		String endedTime = dtf.format(endTime);
	...
	public static Date addDateYear(Date date, int year) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(Calendar.YEAR, year);// 24小时制
		date = cal.getTime();
		return date;
	}
...
//        Integer second = time % 60;
	 ...
	 * 获取当月的第一天
	 */
	public static Date getFirstDayByMonth(String date) {
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
		Calendar c = Calendar.getInstance();
		c.add(Calendar.MONTH, 0);
		c.set(Calendar.DAY_OF_MONTH, 1);// 设置为1号,当前日期既为本月第一天
		Date first = parseStrToDate(format.format(c.getTime()), "yyyy-MM-dd");
		return first;
	}
}
